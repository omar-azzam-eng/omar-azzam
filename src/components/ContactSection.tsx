        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <div>
              ...
              <span className="font-mono text-foreground text-lg">omar.azzam.eng@gmail.com</span>
            </div>
          </a>
          ...
          >
            ...
            <div>
              <span className="text-muted-foreground text-sm block mb-1">Phone</span>
              <span className="font-mono text-foreground text-lg">0959984200</span>
            </div>
          </a>
        </div>
